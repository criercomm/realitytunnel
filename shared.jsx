...
const PROJECTS = [
  {
    ...
    tag: 'Virtual reality', title: 'Manchester United VR',
    sub: 'An Old Trafford experience for global fans.',
    client: 'Manchester United F.C.', year: '2024', metric: '14M views',
    platform: 'Standalone VR · Web', market: 'Global',
  ...
  {
    slug: 'interbank-360',
    tag: '360° photography', title: 'Interbank 360°',
    sub: 'Walk every branch from a single web link.',
    client: 'Interbank', year: '2023', metric: '+38% NPS',
    platform: 'Web · Any device', market: 'Peru',
  ...
  {
    slug: 'hp-ar',
    tag: 'AR · e-commerce', title: 'Hewlett Packard AR',
    sub: 'Try the laptop on your desk before you buy.',
    client: 'Hewlett Packard', year: '2024', metric: '+41% CVR',
    platform: 'Web · iOS · Android', market: 'Global',
  ...
  {
    slug: 'talentolandia',
    tag: 'AR · computer vision', title: 'Talentolandia',
    sub: "Character recognition for kids' learning.",
    client: 'Artesco', year: '2022', metric: '92k installs',
    platform: 'iOS · Android', market: 'Peru',
  ...
  },
  {
    ...
    tag: 'Educational VR', title: 'Millie the Robot',
    sub: 'A VR science investigation that turns students into detectives.',
    client: 'Students · US', year: '2024', metric: 'K-12 classrooms',
    platform: 'Standalone VR', market: 'United States', audience: 'Students',
  ...
  },
  {
    ...
    tag: 'VR training', title: "Hacker's Worst Nightmare",
    sub: 'Cybersecurity training that employees actually remember.',
    client: 'Hewlett Packard', year: '2023', metric: '4.8/5 retention',
    platform: 'Standalone VR', market: 'United States',
  ...
  {
    slug: 'ra-link-bcp',
    tag: 'Augmented reality', title: 'RA Link — BCP',
    sub: "A year of BCP innovation — each product given its own moment.",
    client: 'Banco de Crédito del Perú', year: '2018', metric: '18 products',
    platform: 'iOS · Android', market: 'Peru',
